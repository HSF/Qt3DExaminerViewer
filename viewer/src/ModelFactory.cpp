...
GeneralMeshModel **ModelFactory::build3DText(){
    ...
    textModel1->translateMesh(QVector3D(0.0f, 0.0f, 50.0f));
    ...
    textModel2->translateMesh(QVector3D(0.0f, 0.0f, -50.0f));
    ...
    textModel3->translateMesh(QVector3D(0.0f, 50.0f, 0.0f));
    ...
    textModel4->translateMesh(QVector3D(0.0f, -50.0f, 0.0f));
    ...
    textModel5->translateMesh(QVector3D(50.0f, 0.0f, 0.0f));
    ...
    textModel6->translateMesh(QVector3D(-50.0f, 0.0f, 0.0f));
